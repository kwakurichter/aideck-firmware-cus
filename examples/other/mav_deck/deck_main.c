...
void start_main_application(void *parameters) {
    ...
    // 4. Start the main mission logic
    mission_start(vehicle_state);

    // 5. The setup task is now finished. Delete it to free resources.
    printf("Main application setup complete. Deleting setup task.\n");
    vTaskDelete(NULL);    
}
