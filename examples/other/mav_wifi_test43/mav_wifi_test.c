...
const char* mission_state_to_string(MissionState_t state) {
    switch (state) {
        ...
        case MISSION_WAIT_FOR_EKF:        return "WAIT_FOR_EKF";
        ...
        switch (g_mission_state) {
            ...
            case MISSION_WAIT_FOR_COMMAND:
                if (is_mission_start) {
                    ...
                    g_mission_state = MISSION_WAIT_FOR_EKF;
                }
                break;
            case MISSION_WAIT_FOR_EKF:
                cpxPrintToConsole(LOG_TO_WIFI, "Waiting for EKF to settle...\n");
            ...
            case MISSION_SET_MODE_LOITER: {
                    ...
                    if (result == MAV_RESULT_ACCEPTED) {
                        cpxPrintToConsole(LOG_TO_WIFI, "Mission: Loiter mode set. Now setting origin.\n");
