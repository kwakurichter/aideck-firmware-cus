    ...
    while (1) {
        ...
        switch (g_mission_state) {
            ...
            case MISSION_SET_EKF_ORIGIN: {
                    mavlink_set_origin(454198610, -756790830, 0);
            ...
            case MISSION_SET_MODE_GUIDED: {
                    mavlink_set_mode(COPTER_MODE_GUIDED_NOGPS);
            ...
            case MISSION_COMMAND_LAND: {
                ...
                if (result == MAV_RESULT_ACCEPTED) {
                    ...
                    cpxPrintToConsole(LOG_TO_WIFI, "Mission: FAILED to LAND (result: %d). Aborting.\n", result);
                    g_mission_state = MISSION_DONE;
                }    
                break;
            }    
