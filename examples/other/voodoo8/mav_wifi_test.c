...
volatile MissionState_t g_mission_state = MISSION_WAIT_FOR_LOITER;
        ...
        switch (g_mission_state) {   
            case MISSION_WAIT_FOR_LOITER:
                if (g_vehicle_state.mode == COPTER_MODE_LOITER) {
                    printf("Mission: Starting Mission! Waiting for EKF to settle...\n");
                    cpxPrintToConsole(LOG_TO_WIFI, "Mission: Starting Misiion! Waiting for EKF to settle...\n");
