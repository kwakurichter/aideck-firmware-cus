    ...
    while (1) {
        ...
        switch (g_mission_state) {   
            ...
            case MISSION_MOVE_LEFT: {
                ...
                mavlink_set_local_target(center_n, tar_e, center_d, 0, -0.3f, 0, center_yaw);
            ...
            case MISSION_MOVE_BACKWARDS: {
                ...
                mavlink_set_local_target(tar_n, center_e - 1.0f, center_d, -0.3f, 0, 0, center_yaw);
            ...
            case MISSION_MOVE_RIGHT: {
                ...
                float cur_e = g_vehicle_state.position_ned[1];
                mavlink_set_local_target(center_n - 1.0f, tar_e, center_d, 0, 0.3f, 0, center_yaw);
                if (fabsf(cur_e - tar_e) <= 0.15f || move_ticks >= MOVE_TICKS) {
                    move_ticks = 0;
                    brake_ticks = 0;
            ...
            case MISSION_MOVE_FORWARD: {
                ...
                float cur_n = g_vehicle_state.position_ned[0];
                mavlink_set_local_target(tar_n, center_e, center_d, 0.3f, 0, 0, center_yaw);
                if (fabsf(cur_n - tar_n) <= 0.15f || move_ticks >= MOVE_TICKS) {
                    move_ticks = 0;
                    brake_ticks = 0;
