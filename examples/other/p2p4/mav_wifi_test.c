        ...
        switch (g_mission_state) {
            ...
            case VOODOO_CONTROL: {
                ...
                if (peer_pitch < -VOODOO_PITCH_THRESHOLD) {
                    ...
                    mavlink_send_rc_override_4ch(STM32_SYSTEM_ID, STM32_COMPONENT_ID, 1500, 1600, 1500, 1500);
                    ...
                    // mavlink_send_manual_control(VOODOO_MOVE_STRENGTH, 0, 500, 0);
                    mavlink_send_rc_override_4ch(STM32_SYSTEM_ID, STM32_COMPONENT_ID, 1500, 1400, 1500, 1500);
                    // mavlink_set_attitude_target(0, -0.261799, 0, 0.5);
                }
                    ...
                    mavlink_send_rc_override_4ch(STM32_SYSTEM_ID, STM32_COMPONENT_ID, 1600, 1500, 1500, 1500);
                    ...
                    // mavlink_send_manual_control(0, -VOODOO_MOVE_STRENGTH, 500, 0);
                    mavlink_send_rc_override_4ch(STM32_SYSTEM_ID, STM32_COMPONENT_ID, 1400, 1500, 1500, 1500);
                    // mavlink_set_attitude_target(-0.261799, 0, 0, 0.5);
                }
                else {
